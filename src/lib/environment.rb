...
module EnvironmentManagement
  ...
  class Environment
    ...
    def old_load_from_file(description, almighty_env_users, user, client, record_in_db,migration=false)
      ...
      debug(client,"!!! Warning: using old environment description format, consider to convert the environment description file to the new format using \"kaenv3 --migrate\" !!!\n\n") unless migration
