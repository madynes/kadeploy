...
class KadeployServer
  ...
  def modify_element(kind,*args,&block)
    options = prepare_element(:modify,kind,&block)
  ...
  def delete_element(kind,*args)
    options = prepare_element(:delete,kind,&block)
