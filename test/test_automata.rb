...
class TestAutomata < Test::Unit::TestCase
  ...
  def test_fail
    ...
    Micro1.any_instance.stubs(:ms_success).lasts(2).returns(true)
    Micro1.any_instance.stubs(:ms_fail).lasts(2).returns(true)
    ...
    Micro2.any_instance.stubs(:ms_success).lasts(4).returns(true)
