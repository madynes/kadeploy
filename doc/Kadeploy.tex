...
\begin{itemize}
  ...
  \begin{itemize}
    \item \yfieldd{headers\_prefix}{String}{X-Auth-} Clients have to provide authentication information through HTTP headers, this is the prefix for each information kind (sample of authentication header information with the default setting: \texttt{X-Auth-User}, \texttt{X-Auth-Certificate})
  \end{itemize}
