...
\begin{itemize}
  ...
  \begin{itemize}
    \item \yfield{bootloader}{String} A script that install a bootloader on the deployment partition. You can use Kadeploy3 environment variables (see section \ref{sec:env_vars}) in this script. Samples of scripts are provided in the distribution (in the directory \texttt{scripts/bootloader/}).
  \end{itemize}
