...
\begin{small}
\begin{verbatim}
> tar xzf kadeploy-3.0-0.tar.gz -C DESTINATION_DIR
\end{verbatim}
\end{small}
...
\end{verbatim}
\end{small}
This will generate three Debian package: \texttt{kadeploy-common-3.0-0.deb}, \texttt{kadeploy-client-3.0-0.deb}, and \texttt{kadeploy-server-3.0-0.deb}.
\subsubsection{Installation}
\noindent On the server side, you have to install the \texttt{kadeploy-common-3.0-0.deb} and \texttt{kadeploy-server-3.0-0.deb} packages.
\begin{small}
\begin{verbatim}
...
\noindent On the client side, you have to install the \texttt{kadeploy-common-3.0-0.deb} and \texttt{kadeploy-client-3.0-0.deb} packages.
\begin{small}
\begin{verbatim}
> dpkg -i kadeploy-common-3.0-0.deb
...
\end{verbatim}
\end{small}
This will generate three rpm package in the RPMS package of your build environment, for instance: \texttt{kadeploy-client-3.0-0.noarch.rpm}, \texttt{kadeploy-server-3.0-0.noarch.rpm}, and \texttt{kadeploy-common-3.0-0.noarch.rpm}.
\subsubsection{Installation}
\noindent On the server side, you have to install the \texttt{kadeploy-common-3.0-0.noarch.rpm} and \texttt{kadeploy-server-3.0-0.noarch.rpm} packages.
\begin{small}
\begin{verbatim}
> rpm -i kadeploy-common-3.0-0.noarch.rpm
> rpm -i kadeploy-server-3.0-0.noarch.rpm
\end{verbatim}
\end{small}

\noindent On the client side, you have to install the \texttt{kadeploy-common-3.0-0.noarch.rpm} and \texttt{kadeploy-client-3.0-0.noarch.rpm} packages.
\begin{small}
\begin{verbatim}
> rpm -i kadeploy-common-3.0-0.noarch.rpm
> rpm -i kadeploy-client-3.0-0.noarch.rpm
\end{verbatim}
\end{small}
...
taktuk_ssh_connector = ssh -q -o StrictHostKeyChecking=no \
                              ...
                              -o BatchMode=yes -i /.keys/id_deploy
...
cmd_soft_reboot_ssh = ssh -q -o BatchMode=yes -o StrictHostKeyChecking=no \
                             ...
                             -i /.keys/id_deploy root@HOSTNAME_FQDN /sbin/reboot
