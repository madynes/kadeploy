...
\end{verbatim}
\end{small}
This will generate three rpm package in the RPMS package of your build environment, for instance: \texttt{kadeploy-client-3-beta.fc11.noarch.rpm}, \texttt{kadeploy-server-3-beta.fc11.noarch.rpm}, and \texttt{kadeploy-common-3-beta.fc11.noarch.rpm}.
\subsubsection{Installation}
\noindent On the server side, you have to install the \texttt{kadeploy-common-3-beta.fc11.noarch.rpm} and \texttt{kadeploy-server-3-beta.fc11.noarch.rpm} packages.
\begin{small}
\begin{verbatim}
> rpm -i kadeploy-common-3-beta.fc11.noarch.rpm
> rpm -i kadeploy-server-3-beta.fc11.noarch.rpm
\end{verbatim}
\end{small}

\noindent On the client side, you have to install the \texttt{kadeploy-common-3-beta.fc11.noarch.rpm} and \texttt{kadeploy-client-3-beta.fc11.noarch.rpm} packages.
\begin{small}
\begin{verbatim}
> rpm -i kadeploy-common-3-beta.fc11.noarch.rpm
> rpm -i kadeploy-client-3-beta.fc11.noarch.rpm
\end{verbatim}
\end{small}
...
\begin{small}
\begin{verbatim}
> /usr/local/kadeploy3/sbin/kadeploy3_server
\end{verbatim}
\end{small}
\noindent or in background using the rc script:
\begin{small}
\begin{verbatim}
> /etc/init.d/kadeploy3_server start
\end{verbatim}
\end{small}
