...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \yfieldd{keep\_connections}{Boolean}{true} use Taktuk in interactive mode in order to keep the connections between the nodes open when executing several commands.
  \end{itemize}
