...
On the client side, you only have to configure the file named \texttt{client\_conf}. This file defines one Kadeploy server per line. For instance:
\begin{verbatim}
default = localhost:25300
