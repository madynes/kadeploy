...
\begin{itemize}
  ...
  \begin{itemize}
    \item \yfield{bootloader}{String} A script that install a bootloader on the deployment partition. This script can use Kadeploy3 environment variables (see \ref{sec:envvars}).
  \end{itemize}
