...
\begin{itemize}
  ...
  \item \ypath{/pxe/dhcp} the default PXE method used to boot over the network. Further information are available in the paragraph \texttt{Booting over the network}.
  \begin{itemize}
